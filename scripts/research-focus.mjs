...
const stages = [
  {en:'In Vitro',ko:'세포시험',sub:'CELL-BASED STUDY',image:'research-focus-cell.png',items:['ROS 활성산소 억제','Aβ 응집 차단','신경세포 생존 증가']},
  {en:'In Vivo',ko:'동물시험',sub:'ANIMAL STUDY',image:'research-focus-animal.png',items:['Y-maze 공간기억 증가','GFAP/Iba-1 억제','타우 독성 완화']},
  {en:'Human',ko:'인체적용시험',sub:'HUMAN STUDY',image:'research-focus-human.png',items:['55세~85세 MCI(경도인지장애)를 호소하는 성인 남녀','고대구로병원, 김천의료원','16주 무작위배정 대조 실험','인지기능관련 지표 평가']},
  {en:'MFDS Recognition Process',ko:'개별인정형 원료 인정 절차',sub:'REGULATORY PROCESS',image:'research-focus-process.png',items:['인체적용시험 완료','관련 연구자료 정리','인정 절차 진행']}
];
