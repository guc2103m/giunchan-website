...
export const pages:Record<string,PageInfo>={
 ...
 '/brands':p('BRANDS','매일의 건강을 돋우다.\n기운을 다시 세우는 하루.','건강을 돋우는 종합 건강 브랜드, 도두온','/assets/product-premium.webp'),
 '/brands/dodoon':p('BRANDS · 도두온','매일의 건강을 돋우다.\n기운을 다시 세우는 하루.','‘돋우다’에서 시작된 이름, 따뜻함을 담은 온(溫)','/assets/product-premium.webp'),
