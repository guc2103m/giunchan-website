...
export function ContactForm(){
 ...
 if(done)return <output className="form-success"><h3>문의 작성 시연이 완료되었습니다.</h3><p>내용은 전송되거나 저장되지 않았습니다. 실제 상담은 이메일 또는 전화로 연락해 주세요.</p><p><a href="mailto:guc2203@guc.co.kr">guc2203@guc.co.kr</a> · <a href="tel:0415792203">041-579-2203</a></p><button onClick={()=>setDone(false)} className="button dark">다시 작성</button></output>;
